...
library LibMap_bytes32_bytes32
{
	...
	{
		require(contains(_map, _key), "LibMap_bytes32_bytes32: key not found");
	...
	function set(map storage _map, bytes32  _key, bytes32  _value)
